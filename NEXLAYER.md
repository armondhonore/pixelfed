...
**Live:** [https://relaxed-weasel-pixelfed.cloud.nexlayer.ai](https://relaxed-weasel-pixelfed.cloud.nexlayer.ai)  

**Runtime:**  · **Port:** auto-detected · **Deploy branch:** dev

---

## How this deployment works

**pixelfed** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
platform where every push to `dev` triggers a fully automated build-and-deploy
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/zknt/pixelfed:latest
    path: /
    servicePorts:
    - 80
    vars:
      ...
      APP_URL: "https://relaxed-weasel-pixelfed.cloud.nexlayer.ai"
      APP_DOMAIN: "relaxed-weasel-pixelfed.cloud.nexlayer.ai"
      ADMIN_DOMAIN: "relaxed-weasel-pixelfed.cloud.nexlayer.ai"
      SESSION_DOMAIN: "relaxed-weasel-pixelfed.cloud.nexlayer.ai"
      APP_KEY: "base64:D41iXqDiRU5tV68xVXQgJw+IqjjJM/14sR84zYDaEnk="
    volumes:
    - name: pixelfed-storage
...
Triggers on:
- **Push** to `dev` → production redeploy
...
> `<podName>.pod:<port>` syntax. CI/CD runs on push to `dev`."*
